...
internal struct TextCell<Message: ChatMessage>: View {
    ...
    private var defaultText: some View {
        Text(text)
            ...
            .clipShape(RoundedCornerShape(radius: cellStyle.cellCornerRadius, corners: message.isSender ? cellStyle.cellRoundedClientCorners : cellStyle.cellRoundedBotCorners))
            .overlay(
                RoundedCornerShape(radius: cellStyle.cellCornerRadius, corners: message.isSender ? cellStyle.cellRoundedClientCorners : cellStyle.cellRoundedBotCorners)
                .stroke(
